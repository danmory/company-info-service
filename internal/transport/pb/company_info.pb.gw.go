...
// RegisterCompanyInfoSearcherHandlerServer registers the http handlers for service CompanyInfoSearcher to "mux".
...
func RegisterCompanyInfoSearcherHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CompanyInfoSearcherServer) error {
	...
	mux.Handle("GET", pattern_CompanyInfoSearcher_Search_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/.CompanyInfoSearcher/Search", runtime.WithHTTPPathPattern("/inn/{inn}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_CompanyInfoSearcher_Search_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_CompanyInfoSearcher_Search_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
// RegisterCompanyInfoSearcherHandlerFromEndpoint is same as RegisterCompanyInfoSearcherHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterCompanyInfoSearcherHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterCompanyInfoSearcherHandler(ctx, mux, conn)
}
...
func RegisterCompanyInfoSearcherHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CompanyInfoSearcherClient) error {
	...
	mux.Handle("GET", pattern_CompanyInfoSearcher_Search_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/.CompanyInfoSearcher/Search", runtime.WithHTTPPathPattern("/inn/{inn}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_CompanyInfoSearcher_Search_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_CompanyInfoSearcher_Search_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 0}, []string{"inn"}, ""))
)

var (
	forward_CompanyInfoSearcher_Search_0 = runtime.ForwardResponseMessage
)
